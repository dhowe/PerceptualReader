...
// Enumerate incompatible combintations 
...
//System.out.println(baseForm+") checking: "+currentRule);
...
REPLACE!
   ...
   */
    ...
    if (passive) {      
      ...
      conjStack.push(pp);
//System.out.println("passive: pushing "+pp);      
    ...
    if (frontVG != null) {
      ...
      /// when could this happen, examples???
        ...
        String verbForm = getVerbForm
          (getBaseForm(frontVG), tense, person, number);
    ...
    if (s.trim().endsWith("peted"))
      throw new RiTaException(this.toString());
    
    return s.trim();
    //return vgComponents.toString(); // fix
  }
  ...
  public String[] getAllConjugations() {
  ...
  {
    RiConjugator rc = null;
    /*    
    rc = new RiConjugator();
    Set s = new HashSet();
    rc.conjugateAll("walk", s);
    for (Iterator it = s.iterator(); it.hasNext();) 
      System.out.println(it.next());      
    
    //System.out.println(RiTa.asList(rc.conjugateAll("run")));
    ...
    */
    ...
    String s = "glare";
    rc = new RiConjugator();    
    System.out.println(rc.getPresentParticiple(s));
    System.out.println(rc.getPast(s));
    /*rc.setNumber("plural");
    rc.setPerson("2nd");
    rc.setTense("past");      
    rc.setPassive(true);
