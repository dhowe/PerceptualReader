...
//  private RiStemmer stemmer;
  ...
  private static final String VL = "[lraeiou]";
	...
	private static final RegexRule[] PLURAL_RULES = new RegexRule[] {
			new RegexRule("^(piano|photo|solo|ego|tobacco|cargo|golf|grief)$", 0,"s", 0),
			new RegexRule("^(wildlife)$", 0, "s", 0),
			new RegexRule(C + "o$", 0, "es", 1),
			new RegexRule(C + "y$", 1, "ies", 1),
			new RegexRule("([zsx]|ch|sh)$", 0, "es", 1),
			new RegexRule(VL + "fe$", 2, "ves", 1),
			new RegexRule(VL + "f$", 1, "ves", 1),
			new RegexRule("(eu|eau)$", 0, "x", 1),
			new RegexRule("(man|woman)$", 2, "en", 1),

			new RegexRule("money$", 2, "ies", 0),
			new RegexRule("person$", 4, "ople", 0),
			new RegexRule("motif$", 0, "s", 0),
			new RegexRule("^meninx|phalanx$", 1, "ges", 0),
			new RegexRule("(xis|sis)$", 2, "es", 0),
			new RegexRule("schema$", 0, "ta", 0),
			new RegexRule("^bus$", 0, "ses", 0),
			new RegexRule("child$", 0, "ren", 0),
			new RegexRule("^(curi|formul|vertebr|larv|uln|alumn|signor|alg)a$", 0,"e", 0),
			new RegexRule("^corpus$", 2, "ora", 0),
			new RegexRule("^(maharaj|raj|myn|mull)a$", 0, "hs", 0),
			new RegexRule("^aide-de-camp$", 8, "s-de-camp", 0),
			new RegexRule("^apex|cortex$", 2, "ices", 0),
			new RegexRule("^weltanschauung$", 0, "en", 0),
			new RegexRule("^lied$", 0, "er"),
			new RegexRule("^tooth$", 4, "eeth", 0),
			new RegexRule("^[lm]ouse$", 4, "ice"),
			new RegexRule("^foot$", 3, "eet", 0),
			new RegexRule("femur", 2, "ora", 0),
			new RegexRule("goose", 4, "eese", 0),
			new RegexRule("(human|german|roman)$", 0, "s", 0),
			new RegexRule("(crisis)$", 2, "es", 0),
			new RegexRule("^(monarch|loch|stomach)$", 0, "s", 0),
			new RegexRule("^(taxi|chief|proof|ref|relief|roof|belief)$", 0, "s", 0),
			new RegexRule("^(co|no)$", 0, "'s", 0),

			// Latin stems
			new RegexRule("^(memorandum|bacterium|curriculum|minimum|"
					+ "maximum|referendum|spectrum|phenomenon|criterion)$", 2,"a", 0),
			new RegexRule("^(appendix|index|matrix)", 2, "ices", 0),
			new RegexRule("^(stimulus|alumnus)$", 2, "i", 0),
